...
function CardCorrelates({ data }) {

    const { prefercolor, isPrefer } = useContext(CartContext);
    const { name, price, image, discount_amount, slug, discount_start, discount_end } = data;
    ...
    return <>
        ...
        <div className="gold-gradient-border mb-4 h-60">
