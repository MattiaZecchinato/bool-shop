            ...
            <div className="container">
                <div className="row d-flex justify-content-around align-items-center">
                    <div className="col-md-3 col-12 text-center">
                        <h4 className="fw-bold">Link Utili</h4>
                    ...
                    <div className="col-md-6 text-center col-sm-12">
                        ...
                        <h2 className="mb-3 fw-bold">Unisciti al mondo dei giochi da tavolo!</h2>
                    ...
                    <div className="col-md-3 text-md-end text-center col-12">
                        <h5 className="text-center pb-2 fw-bold">Seguici sui social</h5>
