function TermOfServicePage() {
    ...
    return <div className="container p-4">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BoolShop.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to BoolShop, accessible from <a href="http://boolshop.it" rel="external nofollow noopener" target="_blank">http://boolshop.it</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: info@boolshop.it</li>
        </ul>
    </div>
}
